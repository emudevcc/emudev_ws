...
- [x] Create `skill-type.ts` with 8 fields, 2 enums, preview, ordering
- [x] Create `experience-type.ts` with 13 fields (incl. tech ref), preview, ordering
- [x] `npm run typecheck` passes

## Success Criteria

- [x] Skill document validates with required name + slug
- [x] Experience document validates with required role.en + company + startDate
- [x] Experience.tech reference picker shows Skill documents in Studio (post-Phase 7)
- [x] Empty `endDate` saves successfully (current role)
- [x] Category/level/employmentType enums appear as dropdowns
