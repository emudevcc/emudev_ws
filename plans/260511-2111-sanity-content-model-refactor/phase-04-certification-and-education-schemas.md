...
- [x] Create `certification-type.ts` with 9 fields, skills ref, preview, ordering
- [x] Create `education-type.ts` with 7 fields, year validation, custom preview
- [x] `npm run typecheck` passes

## Success Criteria

- [x] Certification validates required name + issuer + issueDate
- [x] Certification.skills picker shows Skill docs (post-Phase 7)
- [x] Education enforces year range 1900-2100
- [x] Education preview shows "Institution — Degree (2018–2022)" or "(2020–Present)"
