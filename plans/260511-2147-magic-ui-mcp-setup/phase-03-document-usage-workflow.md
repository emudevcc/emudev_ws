...
`@magicuidesign/mcp` is configured globally in `~/.claude.json` via `claude mcp`.
...
- [x] Read current `docs/code-standards.md` to find insertion point
- [x] Add Magic UI MCP section
- [x] Fill in Pro access outcome from Phase 2 result

## Success Criteria

- [x] `docs/code-standards.md` has Magic UI MCP section
- [x] Workflow is reproducible from docs alone for a new team member
- [x] No token values in docs
